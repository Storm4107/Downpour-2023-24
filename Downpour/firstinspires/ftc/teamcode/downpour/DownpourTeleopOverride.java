...
public class DownpourTeleopOverride extends LinearOpMode {
    ...
    static final int ElbowLimit = 2150;
            ...
            while (opModeIsActive()) {
                ...
                if(gamepad1.right_bumper) {
                    ...
                    Drivespeedmult = 1;
                        ...
                        double ElbowInputraw = gamepad2.right_stick_y * 50;
                        
                        int ArmInput = (int) Math.floor(ArmInputraw);
                        int ElbowInput = (int) Math.floor(ElbowInputraw);
                        
                        ArmTarget = ArmTarget + (ArmInput);
                        ElbowTarget = ElbowTarget + (ElbowInput);
                ...
                //Joint Control/limit
                if (ElbowTarget > ElbowLimit) {
                    ElbowTarget = ElbowTarget;
                } else if(ElbowTarget < 0) {
                   ElbowTarget = ElbowTarget;
                } else {
                    ElbowTarget = ElbowTarget;
                }
